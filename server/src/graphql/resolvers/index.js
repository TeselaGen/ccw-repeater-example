...
module.exports = function generateCoreResolver(db, DataLib, opts){
    ...
    nestedResolvers = {
        category: function(todo, { filter, sort, pageNumber, pageSize }, context, info ){
            let dataLib = getDataLibWithContext(db, context);
            if(todo.categoryId != null){
                let fields = Object.keys(graphqlFields(info));
                let fkFilter = { id: todo.categoryId };
        ...
        user: function(todo, { filter, sort, pageNumber, pageSize }, context, info ){
            let dataLib = getDataLibWithContext(db, context);
            if(todo.userId != null){
                let fields = Object.keys(graphqlFields(info));
                let fkFilter = { id: todo.userId };
    ...
    nestedResolvers = {
        ...
        todos: function(user, { filter, sort, pageNumber, pageSize }, context, info ){
            let dataLib = getDataLibWithContext(db, context);
            if(user.id != null){
                let fields = Object.keys(graphqlFields(info));
                let fkFilter = { userId: user.id };
        ...
        todosCursor: function(user, { filter, sort, pageNumber, pageSize }, context, info ){
            let dataLib = getDataLibWithContext(db, context);
            if(user.id != null){
                let fields = Object.keys(graphqlFields(info));
                let fkFilter = { userId: user.id };
    ...
    nestedResolvers = {
        todos: function(category, { filter, sort, pageNumber, pageSize }, context, info ){
            ...
            if(category.id != null){
                let fields = Object.keys(graphqlFields(info));
                let fkFilter = { categoryId: category.id };
