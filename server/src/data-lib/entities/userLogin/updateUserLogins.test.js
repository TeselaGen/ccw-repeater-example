...
describe("updateUserLogins", () => {
    it("updateUserLogins updates records", async () => {
        ...
        let result = await updateUserLogins.call(ctx, records);
    ...
    it("updateUserLogins doesn't return update count for records that weren't updated", async () => {
    ...
    it("updateUserLogins updates records via cid", async () => {
    ...
    it("updateUserLogins updates records via foreign key filter", async () => {
        ...
        let result = await updateUserLogins.call(ctx, records, { fkAttr: "124" });
    ...
    it("updateUserLogins doesn't update records if only child records are sent", async () => {
    ...
    it("updateUserLogins doesn't return invalid update id's if only child records are sent", async () => {
    ...
    it("updateUserLogins returns empty array", async () => {
        let records = [
            {
                id: "123"
            }
    ...
    it("updateUserLogins throws error on cid as primary key", async () => {
        expect.assertions(1);
        ...
        try{
            await updateUserLogins.call(ctx, records)
        }catch(err){
